...
#(
	...
	assign data_reg_input = comb_output;
	...
	assign integrator_input = data_reg_output;
	...
	// Output
	assign data_o = integrator_output;
		...
		for (i = 0; i < 2; i = i + 1) begin
			...
			always @(posedge clk_r_i) begin
				...
				if (rst_r_i) begin
					...
					time_domain_change_reg[i] <= ena_i ? data_i : 'b0;
