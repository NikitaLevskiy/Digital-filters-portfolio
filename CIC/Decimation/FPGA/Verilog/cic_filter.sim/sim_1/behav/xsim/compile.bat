...
REM
REM Generated by Vivado on Fri Apr 10 16:16:23 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj cic_decimator_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cic_decimator_tb_vlog.prj -log xvlog.log
