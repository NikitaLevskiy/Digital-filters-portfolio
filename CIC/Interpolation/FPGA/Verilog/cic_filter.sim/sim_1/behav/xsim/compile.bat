...
REM
REM Generated by Vivado on Mon Oct 06 19:25:42 +0200 2025
...
echo "xvlog --incr --relax -L uvm -prj cic_filter_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cic_filter_tb_vlog.prj -log xvlog.log
